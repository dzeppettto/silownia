...
function renderTraining() {
  ...
  if (c.category === 'silownia') {
    html += '<div class="card rest-timer"><div class="rt-head">' + icon('clock') + '<div class="rt-time" id="rt-time">' + restTimeText() + '</div></div>' +
      '<div class="chips">' + [60, 90, 120, 180, 240].map(s => '<button class="chip rt-chip' + (restTimer.total === s ? ' active' : '') + '" data-rt="' + s + '">' + s + 's</button>').join('') + '</div>' +
