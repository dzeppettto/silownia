...
const APP_VERSION = 'beta 0.11';

const RELEASE_NOTES = {
  version: 'beta 0.11',
  changes: [
    'Nowa kategoria treningu: Rower — czas, dystans, średnia prędkość, tętno i strefa',
    'Tempo biegu liczone poprawnie (np. 21 km w 1:30 = 4:17 /km)',
    'Kalendarz: podgląd dnia otwiera się w oknie pop-up — nic się nie rozjeżdża na telefonie',
    'Wpisy: tytuł nad kategorią, przyciski Powtórz/Edytuj/Usuń na dole przy kaloriach',
    'Czas można wpisywać z dwukropkiem, np. 1:30 = 1 godz. 30 min',
    'Dopracowany widok na wąskich ekranach (do 320 px)'
  ]
};
...
function entryBox(tag, title, body, notes, kind, id) {
  return '<div class="entry"><div class="entry-head">' +
    ...
    '<span class="e-tag ' + tag + '">' + (tag === 'gym' ? 'Siłownia' : tag === 'run' ? 'Bieganie' : 'Zdrowie') + '</span></div>' +
