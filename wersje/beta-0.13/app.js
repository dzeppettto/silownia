...
const APP_VERSION = 'beta 0.13';

const RELEASE_NOTES = {
  version: 'beta 0.13',
  changes: [
    'Poprawka: podpowiedzi dystansów w zawodach nie rozjeżdżają się już na telefonie',
    'Mięśnie w formularzu treningu są domyślnie zwinięte i mają większy odstęp od „Dodaj ćwiczenia z rozpiski”',
    'Zdjęcia sylwetki można dodawać również z galerii telefonu (wcześniej tylko aparat)'
  ]
};
