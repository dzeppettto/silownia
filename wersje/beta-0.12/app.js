...
const APP_VERSION = 'beta 0.12';

const RELEASE_NOTES = {
  version: 'beta 0.12',
  changes: [
    'Stoper treningu: mniejszy na formularzu i liczy dalej nawet po wyjściu z aplikacji (na podstawie czasu rzeczywistego)',
    'Czas treningu siłowego można wpisać lub poprawić przy edycji wpisu — widać go też w podglądzie dnia',
    'Mięśnie w formularzu siłowni są teraz w zwijanej sekcji',
    'Zawody: podpowiedzi dystansów 5 / 10 / 21,1 / 42,2 km',
    'Zawody: nowy status „Zapisany”',
    'Kalendarz: zawody widoczne w podglądzie dnia (edytowanie i usuwanie)'
  ]
};
